...
The actual numerical scheme, domain decomposition and parallelisation techniques are left as a black box to the user.
...
As the ADER-DG scheme is highly volatile as soon as shocks develop, we additionally provide \textit{a posteriori} finite volume limiting, recently\todo{Is 2016 recently? Originally developed in this paper, or just this special version?} developed by \citeauthor{dumbser2016simple} in~\cite{dumbser2016simple}.
...
We \todo{LR: General introduction is missing. Where do we see our paper, what has been done before? Here we should also introduce and describe the ExaHyPE-Engine as base of the paper} solve the compressible Navier-Stokes equations in the conservative form% \pcref{eq:conservation-law-gradient}
\begin{equation}
