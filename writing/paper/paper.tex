...
The relative error is \num{6.69e-6}\todo{Update these numbers}.
...
\todo{1--2 days on workstation}
\todo{tbb scalability in MDOF/s}
\todo{Resolution low enough: weak scaling would be more interesting}
