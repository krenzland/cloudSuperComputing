...
An introduction to the communication-avoiding implementation of the whole numerical scheme can be found in~\cite{charrier2018stop}.% by \citeauthor{charrier2018stop}.
...
- \cos(x) \sin(y) 
  ...
  \end{split}
\end{align}
The constant $C = \nicefrac{100}{\gamma}$ governs the speed of sound and thus the Mach number $\text{Ma} = 0.1$~\cite{dumbser2016high}, the viscosity is set to $\mu = 0.1$. \todo{grammar broken.}
...
Computing resources were provided by the Leibniz Supercomputing Centre (project XXX). \todo{Add project number(s)?}
