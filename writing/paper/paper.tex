...
\begin{alignedat}{6}
  ...
  \end{alignedat}
\end{equation}
\Cref{eq:manufactured-solution} does not solver the compressible Navier-Stokes equations \cref{eq:equation-set} directly but rather our equation set with ann added source term.
We derive this source term symbolically with a computer algebra system.
...
\todo{Mention simulation order for two bubbles!}
