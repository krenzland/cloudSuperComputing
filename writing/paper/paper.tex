...
The accurate simulation of clouds is crucial for detailed weather prediction.
Because cloud dynamics can be approximated well with the compressible Navier-Stokes equations, this is the equation set of our choice.
These equations are often space-discretized by higher order Galerkin methods, as seen for example in~\cite{giraldo2008study,muller2010adaptive,muller2018strong}.
