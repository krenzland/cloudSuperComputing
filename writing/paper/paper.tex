...
This corresponds to the parameters used in~\cite{kelly2012continuous}\footnote{Note that the parameters presented in~\cite{kelly2012continuous} do not agree with their results, we instead use the same parameters as for 2D simulations.}.
...
Lukas Krenz  was funded by the European Union’s Horizon 2020 Research and Innovation Programme under the project ChEESE, grant no.\ 823844.
