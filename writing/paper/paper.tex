...
A comparison at time $t = 10.0$ of the analytical solution for the velocities with our approximation (\cref{fig:taylor-green}) shows an excellent agreement.
...
\begin{minipage}{.5\textwidth}
  \centering
    ...
    All other axes are held constant at a value of 0.}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
...
In addition, we simulated the same scenario with our \muscl{} method, using $3^2$ patches with $80^2$ finite volume cells each and no viscosity~\todo{check}.
