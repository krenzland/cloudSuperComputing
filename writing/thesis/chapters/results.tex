...
\begin{figure}[htb]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[trim={0.00cm 0.00cm 8.4cm 0.0cm},clip]{thesis_cosine_bubble_pertubation_comparison}
    \caption{\label{fig:cosine-bubble-potT-ours}%
      Our result}
  \end{subfigure}~%
  \begin{subfigure}[t]{0.55\textwidth}
    \centering
    \includegraphics[trim={7.00cm 0.00cm 0.0cm 0.0cm},clip]{thesis_cosine_bubble_pertubation_comparison}
