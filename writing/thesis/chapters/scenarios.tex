...
This scenario for the reactive Euler-equations is set up in a 2D box of size $[-1, 1] \times [-1, 1]$ surrounded by free-slip walls~\pcref{eq:free-slip}.
...
\begin{align}
  ...
  \end{split}
\end{align}
\todo{We and dumbser use $\Pr = 0.75$, check!}
\todo{What about viscous effects?}
