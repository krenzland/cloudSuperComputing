...
As a simple test case, we consider the cosine bubble scenario that describes a background atmosphere that is perturbed by a large warm air bubble in the middle of the domain~\cite{giraldo2008study}.
