...
\todo{Std is still slightly biased!}
Because of this, we multiply the estimate of \cref{alg:merge-variance} with $\nicefrac{n-1}{n}$ to undo the correction.\todo{Is this actually correct? Doesn't bessel's correction come from the dofs ``used for the mean?''. (Doesnt really matter anyway.)}
