...
\item Due to the \textsc{cfl}-condition~\pcref{eq:cfl-aderdg,eq:cfl-muscl}, the number of timesteps of our \aderdg{}-scheme scales quadratically with the number of grid cells.
